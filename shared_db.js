...
// Firebase Functions の初期化（失敗してもアプリ全体を止めない）
try {
window.functions = firebase.app().functions(‘asia-northeast1’);
} catch (e) {
